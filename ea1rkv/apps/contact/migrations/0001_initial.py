    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intro', wagtail.fields.RichTextField(blank=True, help_text='Text displayed above the form')),
                ('thank_you_text', wagtail.fields.RichTextField(blank=True, help_text='Text displayed after successful form submission')),
                ('map_embed_url', models.URLField(blank=True, help_text='Google Maps or OpenStreetMap embed URL for club location')),
            ],
            options={
